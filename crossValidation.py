...
parser.add_argument('--sample_count', type=str, default='sumple-num-1.csv')
...
sample_count = config.data_folder + config.sample_count
...
sampleC=[]
sampleD=[]
sumple_num = pd.read_csv(sample_count)
