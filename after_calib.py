...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_file', type=str, default='Person1Day2_baseline.csv')
    parser.add_argument('--test_file', type=str, default='Person1Day1_baseline.csv')
    parser.add_argument('--MALDI_MS', type=bool, default=False, help='flag of dataset, False for CyTOF, True for MALDI_MS')
    ...
    parser.add_argument('--alpha', type=bool, default=0.01, help='coefficient of reconstruction loss')
    parser.add_argument('--beta', type=bool, default=1, help='coefficient of calibration loss')
    parser.add_argument('--gamma', type=bool, default=0.01, help='coefficient of classification loss')
