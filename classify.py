...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_file', type=str, default='Person1Day1_baseline.csv')
    parser.add_argument('--test_file', type=str, default='Person1Day2_baseline.csv')
    parser.add_argument('--MALDI_MS', type=bool, default=False)
    ...
    parser.add_argument('--gamma', type=int, default=10, help='regularization between classification and others')
    ...
    if config.MALDI_MS == True:    
        sumple_num = pd.read_csv(data_folder+'sumple-num-1.csv')
